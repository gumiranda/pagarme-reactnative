...
const formSchema = Yup.object().shape({
  ...
  street_number: Yup.string().required('Obrigatório'),
});
export default function PaymentAddress({navigation}) {
  ...
  const handleCepBlur = async (setValues, values) => {
    try {
      const {state, city, street, neighborhood} = await cep(values.zipcode);
      setValues({
        ...values,
        state,
        city,
          ...
          {({
            ...
            <Form>
              ...
              <FormInput
                ...
                typeMask="cep"
                onSubmitEditing={() => {
                  handleCepBlur(setValues, values);
                  streetnumberRef.current.focus();
                }}
              ...
              <FormInput
                ...
                onBlur={() => handleCepBlur(setValues, values)}
              ...
              <FormInput
                ...
                onBlur={() => handleCepBlur(setValues, values)}
                onChangeText={() => handleCepBlur(setValues, values)}
              />
